...
:host {
    ...
    /* knob */
    --knob-track-background-color: #000000;
    --knob-track-value-color: #000000;

    --knob-dial-border-color: var(--foreground);
    --knob-dial-background-color: grey;
    --knob-dial-tick-color: var(--foreground);

    /* switch */
    --switch-outline-color: var(--foreground);
    --switch-thumb-color: grey;
    --switch-on-background-color: grey;
    --switch-off-background-color: grey;
...
.switch-outline {
    ...
    width: 2.5rem;
    border-radius: 12rem;
    box-shadow: 0 0 0 50px var(--switch-outline-color);
